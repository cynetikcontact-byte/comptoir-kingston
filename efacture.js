...
function facturxXML(inv) {
  ...
  return '<?xml version="1.0" encoding="UTF-8"?>\n' +
    ...
    '  <rsm:ExchangedDocument><ram:ID>' + esc(inv.number) + '</ram:ID><ram:TypeCode>' + (inv.typeCode || 380) + '</ram:TypeCode><ram:IssueDateTime><udt:DateTimeString format="102">' + inv.date + '</udt:DateTimeString></ram:IssueDateTime></rsm:ExchangedDocument>\n' +
